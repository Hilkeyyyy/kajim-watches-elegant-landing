-- Update upsert_site_settings to handle footer and social fields
...
BEGIN
  ...
  -- Get the single settings row id if exists
  ...
  IF v_id IS NULL THEN
    ...
    VALUES (
      ...
      COALESCE(new_settings->'social_links', '{"twitter":"","facebook":"","whatsapp":"","instagram":""}'::jsonb),
      COALESCE(new_settings->'footer_contact_info', '{"email":"","phone":"","address":""}'::jsonb),
