...
-- 3. Atualizar função existente para incluir proteção contra mudança de role
...
AS $function$
BEGIN
  -- Permitir se for super admin ou role não mudou
...
-- 4. Recriar trigger com nome atualizado
...
-- 4. Atualizar política para prevenir inserções maliciosas em audit_logs
